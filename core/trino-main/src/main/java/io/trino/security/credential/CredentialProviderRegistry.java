...
{
    private final Map<String, CredentialProviderFactory> factories = new HashMap<>();
    private final CredentialProviderStore credentialProviderStore;
    private Map<String, CredentialProvider> credentialProviders = ImmutableMap.of();
    ...
    {
        factories.put(credentialProviderFactory.getFactoryName(), credentialProviderFactory);
    }

    public void loadCredentialProviders()
    {
        credentialProviders = credentialProviderStore.loadCredentialProviders(factories);
    }
